...
public class Boots extends Armor {
	...
	public Boots(int atk, int magic, int def, double weight, int hpBoost, int manaBoost, int value, Rarity howRare, ArmorType armorType) {
	...
	public Boots(int atk, int magic, int def, double weight, int hpBoost, int manaBoost, int value,
	...
	public Boots() {
		super(0, 0, 3, 3.0, 0, 0, 65, Item.randomRareness(), Armor.getRandomArmorType());
		this.setImageLocation("Images\\Armors\\" + this.getArmorType().toString() + "\\Boots.png");
		this.setSimpleName(this.getArmorType() + " boots");
		this.setItemToolTipText("A pair of " + this.getArmorType() + " boots");
	}
